class IssueModal {
  ...
  selectIssueTypeTaskIcon(taskIcon) {
    cy.get(`[data-testid="icon:${taskIcon}"]`)
      .should('be.visible')
      .trigger('mouseover')
      .trigger('click');
  }

  selectIssueTypeBugIcon(bugIcon) {
    cy.get(`[data-testid="icon:${bugIcon}"]`)
      .should('be.visible')
      .trigger('mouseover')
      .trigger('click');
  }

  selectIssueTypeStoryIcon(storyIcon) {
    cy.get(`[data-testid="icon:${storyIcon}"]`)
      .should('be.visible')
      .trigger('mouseover')
      .trigger('click');
  }
