class IssueModal {
  ...
  validateIconIsVisible(icon) {
    cy.get(`[data-testid="icon:${icon}"]`).should('be.visible');
  }

  selectIssueTypeTaskIcon() {
  ...
  selectIssueTypeStoryIcon() {
    cy.get('[data-testid="icon:story"]')
      .should('be.visible')
      .trigger('mouseover')
      .trigger('click');
  }
