class TimeTrackingModal {
  ...
  selectPriorityHigh() {
    cy.get(this.priorityDropdown).click('bottomRight');
    cy.get(this.selectOptionHigh).click();
    cy.get(this.priorityDropdown).should('contain', 'High');
  }

  selectPriorityMedium() {
    cy.get(this.priorityDropdown).click();
    cy.get(this.selectOptionMedium).click();
    cy.get(this.priorityDropdown).should('contain', 'Medium');
  }
