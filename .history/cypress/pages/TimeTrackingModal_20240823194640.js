class TimeTrackingModal {
  ...
  selectIssueType(issueType) {
    this.selectDropdownOption(this.issueType, issueType).wait(6000);
  }

  selectPriority(priority) {
    this.selectDropdownOption(this.priorityDropdown, priority).wait(6000);
  }

  selectReporter(reporterName) {
    this.selectDropdownOption(this.reporter, reporterName).wait(6000);
  }

  selectAssignee(assigneeName) {
    this.selectDropdownOption(this.assignee, assigneeName).wait(6000);
  }
