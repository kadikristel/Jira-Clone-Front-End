class IssueModal {
  ...
  selectIssueType(issueType) {
    ...
    if (issueType === 'Story') {
      cy.get(this.storyIcon).trigger('mouseover').trigger('click');
    } else if (issueType === 'Bug') {
      cy.get(this.bugIcon).trigger('mouseover').trigger('click');
    } else if (issueType === 'Task') {
      cy.get(this.taskIcon).trigger('mouseover').trigger('click');
    } else {
