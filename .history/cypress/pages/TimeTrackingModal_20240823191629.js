class TimeTrackingModal {
  constructor() {
    ...
    this.allIssueOptions = '[data-testid^="select-option:"]';
  ...
  createIssue(issueDetails) {
    this.getIssueModal().within(() => {
      ...
      cy.get(this.allIssueOptions).contains(issueDetails.issueType).click();
      ...
      cy.get(this.allIssueOptions).contains(issueDetails.reporter).click();
      cy.get(this.assignee).click();
      cy.get(this.allIssueOptions).contains(issueDetails.assignee).click();
      cy.get(this.priority).click();
      cy.get(this.allPriorityOptions).contains(issueDetails.priority).click();
