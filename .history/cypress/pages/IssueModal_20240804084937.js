...
class IssueModal {
  ...
  selectPriority(priority) {
    ...
    cy.get(this.priorityOption).contains(selectedPriority).should('be.visible').click();
    ...
    if (priority === 'Low') {
      cy.get('[data-testid="select-option:Low"]').should('be.visible');
    } else if (priority === 'Medium') {
      cy.get('[data-testid="select-option:Medium"]').should('be.visible');
    } else if (priority === 'High') {
      cy.get('[data-testid="select-option:High"]');
    } else if (priority === 'Highest') {
      cy.get('[data-testid="select-option:Highest"]');
    } else {
      throw new Error(`Unknown priority type: ${priority}`);
    }
  }
  ...
  */
  ...
  createIssue(issueDetails) {
    this.getIssueModal().within(() => {
      ...
      const priority = issueDetails.priority || 'Medium';
