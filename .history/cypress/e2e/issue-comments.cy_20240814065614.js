...
describe('Issue comments creating, editing and deleting', () => {
  ...
  it.only('Should delete a comment successfully', () => {
    CommentModal.getIssueDetailsModal().within(() => {
      cy.get(CommentModal.issueComment).contains('Delete').click();
      cy.get(CommentModal.confirmationPopup)
        .contains('button', 'Delete comment')
        .and('contains', 'Are you sure you want to delete this comment?')
        .and('contains', "Once you delete, it's gone for good.")
        .click()
        .should('not.exist');
      cy.get(CommentModal.getIssueDetailsModal)
    ...
    it('Should create a comment, edit creatd');
  });
});
