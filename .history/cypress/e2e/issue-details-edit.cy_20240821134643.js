  ...
  it.only('Should check Priority dropdown values for existing issue', () => {
    ...
    cy.get('[data-testid="select:priority"]')
      ...
      .each(($option) => {
        ...
        cy.log("Added value:", optionText, "Array length:", priorityValues.length);
      })
      .then(() => {
           const expectedPriorities = ["Medium", "Lowest", "Low", "High", "Highest"];
