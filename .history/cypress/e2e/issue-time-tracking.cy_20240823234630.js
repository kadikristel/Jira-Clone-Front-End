...
describe('Time estimation functionality for new issue', () => {
  ...
  it('Should add, edit and remove the time estimation for the issue', () => {
    ...
    cy.get(TimeTrackingModal.issueCreateModal).within(() => {
      cy.get(TimeTrackingModal.issueType).click('bottomRight');
      cy.get(TimeTrackingModal.issueTypeBug).wait(6000).click({ force: true });
      ...
      cy.get(TimeTrackingModal.selectOptionBabyYoda)
        .wait(6000)
        .click({ force: true });
      cy.get(TimeTrackingModal.assignees).click();
      cy.get(TimeTrackingModal.selectoptionLordGaben)
        .wait(6000)
        .click({ force: true });
      cy.get(TimeTrackingModal.priorityDropdown).click('bottomRight');
...
describe('Time tracking functionality for new issue', () => {
  ...
  it('Should add and remove time logging for the issue', () => {
    ...
    cy.get(TimeTrackingModal.issueCreateModal).within(() => {
      cy.get(TimeTrackingModal.issueType).click('bottomRight');
      cy.get(TimeTrackingModal.issueTypeStory)
        .wait(6000)
        .click({ force: true });
      cy.get(TimeTrackingModal.descriptionField)
        .click()
      ...
      cy.get(TimeTrackingModal.title).type(issueTitle);
      cy.get(TimeTrackingModal.reporter).click();
      cy.get(TimeTrackingModal.selectOptionPickleRick)
        .wait(6000)
        .click({ force: true });
      cy.get(TimeTrackingModal.assignees).click();
      cy.get(TimeTrackingModal.selectOptionBabyYoda)
        ...
        .click({ force: true });
      cy.get(TimeTrackingModal.priorityDropdown).click('bottomRight');
      cy.get(TimeTrackingModal.selectOptionLowest).click();
      cy.contains('button', 'Create Issue').click();
      cy.wait(15000);
    });
