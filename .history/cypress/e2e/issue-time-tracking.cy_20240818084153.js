describe('Time estimation functionality', () => {
  ...
  it.only('Should add, edit and remove the estimation of the issue', () => {
    ...
    and('have.attr', 'width', initialWidth);
    ...
    and('contain.text', `${inputHours}h estimated`);
    ...
    and('contain.text', `${editedHours}h estimated`);
    cy.get('.sc-fhYwyz .sc-jzgbtB .sc-gJWqzi').should(
      'not.have.attr',
      'width',
      initialWidth
    ...
    and('not.contain.text', `${editedHours}h estimated`);
    cy.get('.sc-fhYwyz .sc-jzgbtB .sc-gJWqzi').should(
      'have.attr',
      'width',
      initialWidth
