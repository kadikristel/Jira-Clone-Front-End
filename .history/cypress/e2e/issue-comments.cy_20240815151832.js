...
describe('Issue comments creating, editing and deleting', () => {
  ...
  it('Should create a comment, edit created comment and delete a created comment successfully', () => {
    CommentModal.getIssueDetailsModal().within(() => {
      CommentModal.clickAddCommentArea();
      cy.get(CommentModal.commentTextArea).type(commentData.newComment);
      cy.get(CommentModal.commentTextArea).should(
      ...
      cy.get(CommentModal.issueComment).first().contains('Delete').click();
    });
  ...
  it('Should create a comment, cancel editing and delete a created comment successfully', () => {
    CommentModal.getIssueDetailsModal().within(() => {
      CommentModal.clickAddCommentArea();
      cy.get(CommentModal.commentTextArea).type(commentData.newComment);
      cy.get(CommentModal.commentTextArea).should(
      ...
      cy.get(CommentModal.commentTextArea)
        ...
        .should('have.value', '')
        .type(commentData.editedComment);
      cy.contains('button', CommentModal.cancelButtonName)
        .click()
        .should('not.exist');
      cy.get(CommentModal.issueComment)
        .should('contain', 'Edit')
  ...
  it.only('Should create a comment, edit created comment and cancel deletion successfully', () => {
    CommentModal.getIssueDetailsModal().within(() => {
      CommentModal.clickAddCommentArea();
      cy.get(CommentModal.commentTextArea).type(commentData.newComment);
      cy.get(CommentModal.commentTextArea).should(
