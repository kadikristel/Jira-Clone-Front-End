/* In order to run this code successfully please compare Your IssueModal.js with mine: 
...
describe('Issue create', () => {
  ...
  it('Should create a Task issue and validate it successfully using Random Data Plugin', () => {
    IssueModal.createIssue({
      type: 'Task',
