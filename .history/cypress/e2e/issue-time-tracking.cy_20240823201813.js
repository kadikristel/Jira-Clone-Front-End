...
describe('Time estimation functionality for new issue', () => {
  ...
  it('Should add, edit and remove the time estimation for the issue', () => {
    ...
    // Create issue
    TimeTrackingModal.getIssueModal().within(() => {
      TimeTrackingModal.selectIssueType('Bug');
      cy.get(TimeTrackingModal.descriptionField).type(
        issueData.randomDescription
      );
      cy.get(TimeTrackingModal.title).type(issueTitle);
      TimeTrackingModal.selectReporter('Baby Yoda');
      TimeTrackingModal.selectAssignee('Lord Gaben');
      TimeTrackingModal.selectPriority('High');
      TimeTrackingModal.clickCreateIssueButton();
    });
...
describe('Time tracking functionality for new issue', () => {
  ...
  it('Should add and remove time logging for the issue', () => {
    ...
    cy.get(TimeTrackingModal.issueCreateModal).within(() => {
      cy.get(TimeTrackingModal.selectOptionBug);
      cy.get(TimeTrackingModal.descriptionField)
        .click()
        .type(issueData.randomDescription);
      cy.get(TimeTrackingModal.title).type(issueTitle);
      cy.get(TimeTrackingModal.selectReporterBabyYoda);
      cy.get(TimeTrackingModal.selectAssigneeLordGaben);
      cy.get(TimeTrackingModal.selectPriorityHigh);
