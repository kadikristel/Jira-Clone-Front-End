describe("Issue create", () => {
  ...
  const inputNameTitle = "#form-field-8";
  const testDescriptionEditor = ".ql-editor";
  ...
  it.only("Should create a custom issue and validate it successfully", () => {
    cy.get(modalIssueCreate).within(() => {
      ...
      cy.get(inputNameTitle).should("be.visible");
      cy.get(testDescriptionEditor).type("My Bug description");
      cy.get(testDescriptionEditor).should("be.visible");
      selectTypeDropdown;
